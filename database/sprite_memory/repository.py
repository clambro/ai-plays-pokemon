...
from database.sprite_memory.schemas import SpriteMemoryCreate, SpriteMemoryRead, SpriteMemoryUpdate


async def create_sprite_memory(sprite: SpriteMemoryCreate) -> SpriteMemoryRead:
...
async def update_sprite_memory(sprite: SpriteMemoryUpdate) -> SpriteMemoryRead:
