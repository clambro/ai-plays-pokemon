...
Note that successfully navigating to different exploration candidates is not a sign of being stuck in a loop, as long as the target coordinates are all different and it feels like you are making progress.
