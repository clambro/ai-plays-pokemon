...
Remember that you do not have to create a new long-term memory object here if you don't have anything to add, meaning an empty list is a perfectly valid response, and you should certainly not create more than one new long-term memory object at a time.
"""
