...
Think through the information above carefully and then give a boolean answer as to whether or not you should use the critique tool. Being stuck will be obvious, so when in doubt, you should not use the critique tool. The keys in your response are defined as follows:
- "thoughts": One or two sentences describing your situation and why you think you should or should not use the critique tool.
- "should_critique": true/false
""".strip()
