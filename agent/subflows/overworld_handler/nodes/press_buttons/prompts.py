...
Your current iteration memory is repeated below for reference. Pay close attention to your current position and facing direction in the memory below. The "thoughts" in your response will be appended verbatim to the end of this memory, so there is no need to duplicate information.
<last_memory>
{last_memory}
</last_memory>
...
- thoughts: Your one sentence long thoughts on which buttons to press given the information provided. These thoughts will be appended verbatim to the end of the <last_memory> in your rolling memory, so try to continue the thought process from there.
