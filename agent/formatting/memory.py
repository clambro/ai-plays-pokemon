...
def format_rolling_memory(memory: RollingMemory) -> str:
    ...
    return (
        ...
        "confirmation. Current structured game data and fresh tool results take precedence over "
        "memory. If they conflict, reassess the remembered conclusion. The current iteration is "
