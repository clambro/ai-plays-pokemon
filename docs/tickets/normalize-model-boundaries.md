# Ticket: Normalize Model Boundaries

## Outcome

Remove incidental Pydantic usage from internal application state. Use
standard-library dataclasses for trusted domain data and reserve Pydantic for
boundaries that perform validation, serialization, or schema generation.
