...
2. There is a level cap on your party. A Pokemon at the level cap can still battle and be used normally; the cap only prevents it from gaining experience. The level cap increases as you progress through the game. Treat it as a ceiling, not a training target.
...
- You do not need to grind excessively. Most training should come from trainer battles and ordinary progression. An upcoming major battle is not by itself a reason to grind; attempt it with a healthy party and a plausible strategy. After a loss, assess your team's health going in, matchups, and move choices before assuming levels are the problem. If repeated healthy attempts against the same opponent reveal a concrete weakness, focus preparation on that weakness. If grinding is needed, decide what improvement will be enough before starting and stop once you achieve it.
