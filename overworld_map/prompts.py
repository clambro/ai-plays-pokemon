...
Note that this ASCII map comes straight from the game's memory and is therefore perfectly reliable. Screenshots can be misinterpreted, so use the ASCII map to determine the exact location of any sprites or tiles, and consider the screenshot as supplemental information to help you visually interpret the ASCII map.
</map_info>
""".strip()
